...
st.markdown("""<section class='hero'><div class='eyebrow'>Intelligent language workspace</div><h1>🧠 NLP Text Analyzer</h1><p><strong>Natural Language Processing using NLTK and spaCy</strong><br>A beautiful modern interface for performing sentence segmentation, tokenization, stop word removal, stemming, lemmatization, POS tagging, Named Entity Recognition, Dependency Parsing, and Noun Phrase Chunking.</p></section>""", unsafe_allow_html=True)
